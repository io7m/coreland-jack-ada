...
package body jack.port is
  ...
  package cbinds is
    ...
    function name (port : types.port_t) return cs.chars_ptr;
    pragma import (c, name, "jack_port_name");

    function short_name (port : types.port_t) return cs.chars_ptr;
    pragma import (c, short_name, "jack_port_short_name");

    function get_type (port : types.port_t) return cs.chars_ptr;
    pragma import (c, get_type, "jack_port_type");

    function is_mine
      (client : types.client_t;
       port   : types.port_t) return c.int;
    pragma import (c, is_mine, "jack_port_is_mine");

    function set_name
      (port : types.port_t;
       name : cs.chars_ptr) return types.integer_t;
    pragma import (c, set_name, "jack_port_set_name");

    function set_alias
      (port  : types.port_t;
       alias : cs.chars_ptr) return types.integer_t;
    ...
    function request_monitor
      (port   : types.port_t;
       enable : c.int) return types.integer_t;
    ...
    function monitoring (port : types.port_t) return c.int;
    ...
    function connect
      (client      : types.client_t;
       source      : cs.chars_ptr;
       destination : cs.chars_ptr) return types.integer_t;
    ...
    function by_name
      (client : types.client_t;
       name   : cs.chars_ptr) return types.port_t;
  ...
  function name (port : types.port_t) return string is
  begin
    return cs.value (cbinds.name (port));
  end name;

  function short_name (port : types.port_t) return string is
  begin
    return cs.value (cbinds.short_name (port));
  end short_name;

  function get_type (port : types.port_t) return string is
  begin
  ...
  function is_mine
    (client : types.client_t;
     port   : types.port_t) return boolean is
  begin
  ...
  function request_monitor
    (port   : types.port_t;
     enable : boolean) return types.integer_t is
  begin
    if enable then
  ...
  function monitoring (port : types.port_t) return boolean is
  begin
  ...
  function disconnect
    (client : types.client_t;
     port   : types.port_t) return types.integer_t is
  begin
