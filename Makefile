...
jack-client.ali jack-client.o jack-error.ali jack-error.o jack-port.ali \
jack-port.o jack-sample.ali jack-sample.o jack-server.ali jack-server.o \
jack-time.ali jack-time.o jack-transport.ali jack-transport.o jack-types.ali \
jack-types.o jack.ali jack.o
