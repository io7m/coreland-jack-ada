...
package body jack.client is
  ...
  package cbinds is
    ...
    function get_name (client : types.client_t) return cs.chars_ptr;
    pragma import (c, get_name, "jack_get_client_name");

    function set_freewheel
      (client : types.client_t;
       enable : types.integer_t) return types.integer_t;
  ...
  function get_name (client : types.client_t) return string is
  begin
